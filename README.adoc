...
7. run: `sudo docker-compose pull` (this will just pull the latest UI code)
8. run: `sudo docker-compose up -d  --build  --quiet-pull`
9. browse: https://localhost/ (normally this will be https://127.0.0.1/)
10. connect as username `ncroot`, password `ubiqube`
