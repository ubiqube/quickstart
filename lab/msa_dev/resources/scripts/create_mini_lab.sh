 ...
 [
    {
        ...
        "value": {
            ...
            "drawerWidth": {
                "automationDetail": 1000
            },
            "viewMode": {
                "automationDetail": "default"
            },
            "tableRows": {
                "dashboard": 12,
                "managedEntities": 20,
                "managedEntityLogs": 20,
                "managedEntitiesConfigure": 10,
                "history": 20,
                "logs": 20,
                "configurations": 20,
            ...
            "dashboards": [
                {
                    ...
                    "contents": [
                        ...
                        {
                            "key": "Dashboard_zcbbw2qk03",
                            "style": "Dashboard Panel",
                            "type": "MSA Component",
                            "component": "Kibana Dashboard",
                            "title": "Dashboard",
                            "extendedListValues": {
                                "kibanaUrl": "template_default"
                            }
                        }
                    ]
                }
